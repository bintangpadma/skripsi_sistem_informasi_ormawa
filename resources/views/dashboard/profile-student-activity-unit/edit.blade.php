        ...
        <div class="menu-profile">
            ...
            <div class="form grid-cols-1 lg:grid-cols-2">
                <div class="form-input">
                    ...
                    <input type="text" class="input" name="username" placeholder="Masukkan username ukm..." value="{{ auth()->user()->username }}">
                    @error('username')
                    <p class="text-invalid">{{ $message }}</p>
                    @enderror
                </div>
                <div class="form-input">
                    ...
                    <input type="email" class="input" name="email" placeholder="Masukkan email ukm..." value="{{ auth()->user()->email }}">
                    @error('email')
                    <p class="text-invalid">{{ $message }}</p>
                    @enderror
                </div>
                <div class="form-input">
                    ...
                    <input type="text" class="input" name="name" placeholder="Masukkan nama ukm..." value="{{ auth()->user()->student_activity_unit->name }}">
                    @error('name')
                    <p class="text-invalid">{{ $message }}</p>
                    @enderror
                </div>
                <div class="form-input">
                    ...
                    <input type="text" class="input" name="abbreviation" placeholder="Masukkan singkatan ukm..." value="{{ auth()->user()->student_activity_unit->abbreviation }}">
                    @error('abbreviation')
                    <p class="text-invalid">{{ $message }}</p>
                    @enderror
                </div>
                <div class="form-input lg:col-span-2">
                    ...
                    <textarea class="input" name="description" rows="4" placeholder="Masukkan deskripsi ukm...">{{ auth()->user()->student_activity_unit->description }}</textarea>
                    @error('description')
                    <p class="text-invalid">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="form-input">
                    ...
                    <input type="password" class="input" name="old_password" placeholder="Masukkan password lama ukm...">
                    @error('old_password')
                    <p class="text-invalid">{{ $message }}</p>
                    @enderror
                </div>
                <div class="form-input">
                    ...
                    <input type="password" class="input" name="new_password" placeholder="Masukkan password baru ukm...">
                    @error('new_password')
                    <p class="text-invalid">{{ $message }}</p>
                    @enderror
                </div>
