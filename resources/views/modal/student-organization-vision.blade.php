<div class="modal" id="createModal">
    <div class="modal-content">
        ...
        <div class="content-body">
            <form id="buttonCreateStudentOrganizationVision" class="form" method="POST">
                @csrf
...
<div class="modal" id="editModal">
    <div class="modal-content">
        ...
        <div class="content-body">
            <form id="buttonEditStudentOrganizationVision" class="form" method="POST">
                @csrf
                @method('PUT')
                <div class="form-input">
                    <label for="name">Visi</label>
...
<div class="modal" id="deleteModal">
    <div class="modal-content">
        ...
        <div class="content-body">
            <form id="buttonDeleteStudentOrganizationVision" class="form" method="POST">
                @csrf
                @method('DELETE')
