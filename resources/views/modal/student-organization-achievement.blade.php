<div class="modal" id="createModal">
    <div class="modal-content">
        ...
        <div class="content-body">
            <form id="buttonCreateStudentOrganizationAchievement" class="form" method="POST">
                @csrf
...
<div class="modal" id="editModal">
    <div class="modal-content">
        ...
        <div class="content-body">
            <form id="buttonEditStudentOrganizationAchievement" class="form" method="POST">
                @csrf
                @method('PUT')
                <div class="form-input lg:col-span-2">
                    <label for="name">Nama Prestasi</label>
...
<div class="modal" id="deleteModal">
    <div class="modal-content">
        ...
        <div class="content-body">
            <form id="buttonDeleteStudentOrganizationAchievement" class="form" method="POST">
                @csrf
                @method('DELETE')
