<div class="modal" id="createModal">
    <div class="modal-content">
        ...
        <div class="content-body">
            <form id="buttonCreateStudentActivityUnitMission" class="form" method="POST">
                @csrf
...
<div class="modal" id="editModal">
    <div class="modal-content">
        ...
        <div class="content-body">
            <form id="buttonEditStudentActivityUnitMission" class="form" method="POST">
                @csrf
                @method('PUT')
                <div class="form-input">
                    <label for="name">Misi</label>
...
<div class="modal" id="deleteModal">
    <div class="modal-content">
        ...
        <div class="content-body">
            <form id="buttonDeleteStudentActivityUnitMission" class="form" method="POST">
                @csrf
                @method('DELETE')
