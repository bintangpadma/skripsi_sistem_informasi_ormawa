<div class="modal" id="createModal">
    <div class="modal-content">
        ...
        <div class="content-body">
            <form id="buttonCreateStudentActivityUnitDivision" class="form" method="POST">
                @csrf
...
<div class="modal" id="editModal">
    <div class="modal-content">
        ...
        <div class="content-body">
            <form id="buttonEditStudentActivityUnitDivision" class="form" method="POST">
                @csrf
                @method('PUT')
                <div class="form-input lg:col-span-2">
                    <label for="name">Nama Divisi</label>
...
<div class="modal" id="deleteModal">
    <div class="modal-content">
        ...
        <div class="content-body">
            <form id="buttonDeleteStudentActivityUnitDivision" class="form" method="POST">
                @csrf
                @method('DELETE')
